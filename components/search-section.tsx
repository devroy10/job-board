...
export function SearchSection() {
  ...
  return (
    <div className="container  px-4 pt-0 gap-4 py-6">
      <div className="pb-4">
        <h1 className="font-medium text-2xl ">Jobs for you</h1>
        <h3 className="text-black/60">Find recommendations based on your search</h3>
      </div>
